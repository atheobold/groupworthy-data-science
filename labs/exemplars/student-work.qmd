...
This plot is brought to us by Abel Magallon! I thought this plot was 
great because it (1) is easy to read, and (2) has a lot of detailed information. The annotations are great, plot title and subtitle describe the context of what is being plotted, and the facet labels are easy to understand.
...
This plot is brought to us by Joaquin Arredondo! I really appreciated Joaquin's
use of descriptive facet labels and their non-standard colors. The colors almost
look like Rainbow Trout!
...
This plot is brought to us by Samanatha Frick! I appreciated Samantha's use of a
grid of facets, with great labels (and colors)! 
