...
::: {.callout-important}
Be sure to save the file in the Lab 3 folder, inside your Week 3 folder, 
...
**6. What are the demographics of the instructors in this study? Investigate the variables `academic_degree`, `seniority`, and `sex` and summarize your findings in \~3 complete sentences.**
