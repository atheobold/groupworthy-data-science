...
::: {.column width="40%"}
![](images/kitties.jpg){fig-alt="A picture of my two kitties, snuggling on the couch. Both kitties are facing each other, with their noses touching." width="75%"}
:::
:::::::
...
<!-- |  |  | -->
<!-- |----|----| -->
<!-- | Clear Communication | "One person doesn't stay focused on just one thing, isolated from the rest of the team, not knowing what's going on." | -->
<!-- | Problem-solving | "Fantastic problem-solving and analytical skills." | -->
<!-- | Effective Collaboration | "Work with diverse teams to translate requirements into technical solutions." | -->
<!-- | Leadership | "Taking full ownership of technical outcomes to ensure project success." | -->
<!-- | Interpersonal Relationship | "Ability to build effective working relationships with others." | -->
...
knitr::include_graphics("images/rmd-ecosystem.png")
```
