...
In Statistics, there are **two** types of models---the population model and the 
fitted (sample) model.
...
I have left many of you comments on changes to make to your code that I trust 
...
**Q1:** How can you make your code more robust? Using `~` to define a function? 
Using `.x` to indicate where the input should go?
:::

. . .

::: {.midi}
**Q1 & Q3:** How can you incorporate input checks into your function? Checking 
if the input is a data frame? Checking if the variables are the right data type?
Checking if the variables are included in the data frame?
:::

. . .

::: {.midi}
**Q5:** Can you give your function a name that *describes* what it does? (e.g., 
`make_filled_barplot()`, `make_colored_scatterplot()`)
:::

. . .

::: {.midi}
**Q5:** We haven't learned `paste()` or `paste0()` in this class! What functions
have we learned that executed this process?
:::

# [Survey on Experiences in STAT 331 / 531](https://forms.gle/YzZWe2oJZ5eWyTbRA)
