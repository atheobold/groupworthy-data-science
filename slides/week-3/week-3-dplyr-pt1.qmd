...
+ Warm-up for `dplyr` practice activity (30-minutes)
...
+ The `dplyr` [cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/data-transformation.pdf) is included in your coursepack!
