...
::: {.small}
Then, the partner who has the most pets starts as the Typer (typing
and listening to instructions from the Talker)!

- The Talker **does not type**. 
  * The collaborative editing feature should allow you to track what is being 
  typed. 
- The Typer **only types what they are told to type**. 
:::
...
- The person who last occupied the role of Typer will download and submit the `PA-5.html` file for the group.
...
+ **PA 5.1: Scrambled Message**
  + Due Wednesday, October 13 at 5pm
+ Check-in 5.2: Functions from `lubridate`
  + Due Thursday, October 14 at 8am
