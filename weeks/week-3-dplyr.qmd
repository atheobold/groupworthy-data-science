...
📽 [Required Video: Why do I get this message when I load the tidyverse? -- 8 minutes](http://somup.com/crf6q4b920)
...
📖 [Required Reading: Tibbles](https://r4ds.had.co.nz/tibbles.html)

## ✅  Check-in 3.1: Data Structures
...
📖 [Required Reading: Data Transformation](https://r4ds.hadley.nz/data-transform.html)

## dplyr Verbs

::: columns
::: {.column width="40%"}
📽 [Required Video: `filter()` -- 11 minutes](https://youtu.be/pPI-prhLYqI)

📽 [Required Video: `select()` -- 6 minutes](https://youtu.be/OInnmiccHt8)

📽 [Required Video: `mutate()` -- 9 minutes](https://youtu.be/QWyUnQ2EzPs)

</br> </br>

📽 [Required Video: `arrange()` -- 7 minutes](https://youtu.be/4Qhdc81mpvo)

📽 [Required Video: `summarize()`-- 8 minutes](http://somup.com/crflYibWZw)

📽 [Required Video: `group_by()` -- 6 minutes](http://somup.com/crflqbbWFy)
:::
...
📽 [Required Video: The pipe operator -- 8 minutes](http://somup.com/crflYfbWZD)

📽 [Required Video: Extending the pipe -- 3 minutes](http://somup.com/crflYmbWup)

## Practice

💻 [Required Tutorial: Practice with dplyr](https://r-primers.andrewheiss.com/transform-data/03-deriving/)

------------------------------------------------------------------------

## ✅  Check-in 3.2: Data Wrangling
