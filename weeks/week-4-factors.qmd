...
📽 [Required Video: Working with factors using forcats -- 9 minutes](https://www.youtube.com/embed/dAiSYli7tVg)
...
📖 [Required Reading: *R4DS* Chapter 16 (Factors) ](https://r4ds.hadley.nz/factors.html)

### ✅  **Check-in 4.4 Functions from  forcats`*
...
+ largest to smallest based on the values of another variable
+ order of appearance
