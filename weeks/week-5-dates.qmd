...
::: {.column-margin}
::: callout-important
The **lubridate** cheatsheet is in Week 5 of your coursepack! If you do not have a coursepack I would strongly recommending printing the [lubridate cheatsheet](https://rstudio.github.io/cheatsheets/lubridate.pdf).
:::
:::
...
**Q2**: What `tz` would you use for San Luis Obispo? *Use the __exact input__ 
you would use in R!*
