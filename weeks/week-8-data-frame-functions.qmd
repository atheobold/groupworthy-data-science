...
This week, we’re going to learn how to write our own dplyr-like
functions---functions that behave the way dplyr verbs do. To do this, we’ll dive
...
This week, we’re moving from using tidyverse functions for "common" tasks to
learning how to build our own functions for the "less common" ones. By the end, 
you’ll understand not only how to use dplyr, but how to extend it.
...
Now that we’ve learned how to write functions that operate on entire data
frames, we’re going to take this a step further and look more closely at tidy
...
temporarily "masks" the data frame’s columns so they behave like regular
variables.
...
### 📖 [Programming with **dplyr**: Tidy Selection & Data Masking](https://dplyr.tidyverse.org/articles/programming.html)
...
**Question 2:** You’re writing a function that filters rows in a data frame based on a 
...
that column’s value is greater than the threshold. The function call should look
...
### ✅  **Check-in 7.2: Writing Plotting Functions**
