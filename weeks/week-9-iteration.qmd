...
### 📖 [Required Reading: *R4DS* -- The `map()` Functions](https://r4ds.had.co.nz/iteration.html#the-map-functions)

::: {.callout-warning}
## Yes, you should be reading the first edition of R4DS, not the second edition.
:::

### 📖 [Optional Reading: *Advanced R* - Functionals](https://adv-r.hadley.nz/functionals.html)

::: callout-note
# If you want to learn more about the concept of functionals! 
:::

### 📽 [Required Video: Iteration with the `map()` family (6 minutes)](https://www.youtube.com/watch?v=FPD3a6IHO6w)
